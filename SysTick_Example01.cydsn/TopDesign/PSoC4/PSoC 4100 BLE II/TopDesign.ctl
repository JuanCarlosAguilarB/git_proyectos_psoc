...
-- === RGB LED ===
attribute port_location of LED_Min(0) : label is "PORT(2,6)"; -- RED LED
attribute port_location of REPLACE_WITH_ACTUAL_PIN_NAME(0) : label is "PORT(3,6)"; -- GREEN LED
attribute port_location of LED_Sec(0) : label is "PORT(3,7)"; -- BLUE LED
