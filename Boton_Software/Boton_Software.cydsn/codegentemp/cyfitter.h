...
#define isr_glitch__INTC_MASK 0x01u
#define isr_glitch__INTC_NUMBER 0u
#define isr_glitch__INTC_PRIOR_NUM 7u
#define isr_glitch__INTC_PRIOR_REG CYREG_NVIC_PRI_0
...
#define CY_PROJECT_NAME "Boton_Software"
