...
void    Vin1_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Vin1_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Vin1__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Vin1_SetInterruptMode() function.
     *  @{
     */
        #define Vin1_INTR_NONE      (uint16)(0x0000u)
        #define Vin1_INTR_RISING    (uint16)(0x0001u)
        #define Vin1_INTR_FALLING   (uint16)(0x0002u)
        #define Vin1_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Vin1_INTR_MASK      (0x01u) 
#endif /* (Vin1__INTSTAT) */
...
/* SIO registers */
#if defined(Vin1__SIO_CFG)
    #define Vin1_SIO_HYST_EN        (* (reg8 *) Vin1__SIO_HYST_EN)
    #define Vin1_SIO_REG_HIFREQ     (* (reg8 *) Vin1__SIO_REG_HIFREQ)
    #define Vin1_SIO_CFG            (* (reg8 *) Vin1__SIO_CFG)
    #define Vin1_SIO_DIFF           (* (reg8 *) Vin1__SIO_DIFF)
#endif /* (Vin1__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Vin1_0_INTTYPE_REG 		(* (reg8 *) Vin1__0__INTTYPE)
#endif /* (Vin1__INTSTAT) */
