...
*
* \funcusage
*  \snippet VinF_SUT.c usage_VinF_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinF_SUT.c usage_VinF_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinF_SUT.c usage_VinF_Read  
*******************************************************************************/
...
* preferred VinF_Read() API because the 
* VinF_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VinF_SUT.c usage_VinF_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VinF_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VinF_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VinF_0_INTR       (First pin in the list)
    *  - VinF_1_INTR       (Second pin in the list)
    *  - ...
    *  - VinF_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VinF_SUT.c usage_VinF_SetInterruptMode
    *******************************************************************************/
    void VinF_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VinF_0_INTR) != 0u) 
		{ 
			 VinF_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VinF_SUT.c usage_VinF_ClearInterrupt
    *******************************************************************************/
