...
*
* \funcusage
*  \snippet VinB_SUT.c usage_VinB_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinB_SUT.c usage_VinB_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinB_SUT.c usage_VinB_Read  
*******************************************************************************/
...
* preferred VinB_Read() API because the 
* VinB_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VinB_SUT.c usage_VinB_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VinB_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VinB_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VinB_0_INTR       (First pin in the list)
    *  - VinB_1_INTR       (Second pin in the list)
    *  - ...
    *  - VinB_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VinB_SUT.c usage_VinB_SetInterruptMode
    *******************************************************************************/
    void VinB_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VinB_0_INTR) != 0u) 
		{ 
			 VinB_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VinB_SUT.c usage_VinB_ClearInterrupt
    *******************************************************************************/
