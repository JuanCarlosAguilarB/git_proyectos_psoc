...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Count3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Count3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Count3_SetInterruptMode() function.
     *  @{
     */
        #define Count3_INTR_NONE      (uint16)(0x0000u)
        #define Count3_INTR_RISING    (uint16)(0x0001u)
        #define Count3_INTR_FALLING   (uint16)(0x0002u)
        #define Count3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Count3_INTR_MASK      (0x01u) 
#endif /* (Count3__INTSTAT) */
...
/* SIO registers */
#if defined(Count3__SIO_CFG)
    #define Count3_SIO_HYST_EN        (* (reg8 *) Count3__SIO_HYST_EN)
    #define Count3_SIO_REG_HIFREQ     (* (reg8 *) Count3__SIO_REG_HIFREQ)
    #define Count3_SIO_CFG            (* (reg8 *) Count3__SIO_CFG)
    #define Count3_SIO_DIFF           (* (reg8 *) Count3__SIO_DIFF)
#endif /* (Count3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Count3_0_INTTYPE_REG 		(* (reg8 *) Count3__0__INTTYPE)
#endif /* (Count3__INTSTAT) */
