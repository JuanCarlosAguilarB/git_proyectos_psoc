...
*
* \funcusage
*  \snippet Vin7_SUT.c usage_Vin7_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin7_SUT.c usage_Vin7_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin7_SUT.c usage_Vin7_Read  
*******************************************************************************/
...
* preferred Vin7_Read() API because the 
* Vin7_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin7_SUT.c usage_Vin7_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin7_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin7_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin7_0_INTR       (First pin in the list)
    *  - Vin7_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin7_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin7_SUT.c usage_Vin7_SetInterruptMode
    *******************************************************************************/
    void Vin7_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin7_0_INTR) != 0u) 
		{ 
			 Vin7_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin7_SUT.c usage_Vin7_ClearInterrupt
    *******************************************************************************/
