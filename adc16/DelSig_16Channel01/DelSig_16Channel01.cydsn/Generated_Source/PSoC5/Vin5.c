...
*
* \funcusage
*  \snippet Vin5_SUT.c usage_Vin5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin5_SUT.c usage_Vin5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin5_SUT.c usage_Vin5_Read  
*******************************************************************************/
...
* preferred Vin5_Read() API because the 
* Vin5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin5_SUT.c usage_Vin5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin5_0_INTR       (First pin in the list)
    *  - Vin5_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin5_SUT.c usage_Vin5_SetInterruptMode
    *******************************************************************************/
    void Vin5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin5_0_INTR) != 0u) 
		{ 
			 Vin5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin5_SUT.c usage_Vin5_ClearInterrupt
    *******************************************************************************/
