...
*
* \funcusage
*  \snippet Vin3_SUT.c usage_Vin3_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin3_SUT.c usage_Vin3_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin3_SUT.c usage_Vin3_Read  
*******************************************************************************/
...
* preferred Vin3_Read() API because the 
* Vin3_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin3_SUT.c usage_Vin3_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin3_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin3_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin3_0_INTR       (First pin in the list)
    *  - Vin3_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin3_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin3_SUT.c usage_Vin3_SetInterruptMode
    *******************************************************************************/
    void Vin3_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin3_0_INTR) != 0u) 
		{ 
			 Vin3_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin3_SUT.c usage_Vin3_ClearInterrupt
    *******************************************************************************/
