...
*
* \funcusage
*  \snippet Vin8_SUT.c usage_Vin8_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin8_SUT.c usage_Vin8_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin8_SUT.c usage_Vin8_Read  
*******************************************************************************/
...
* preferred Vin8_Read() API because the 
* Vin8_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin8_SUT.c usage_Vin8_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin8_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin8_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin8_0_INTR       (First pin in the list)
    *  - Vin8_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin8_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin8_SUT.c usage_Vin8_SetInterruptMode
    *******************************************************************************/
    void Vin8_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin8_0_INTR) != 0u) 
		{ 
			 Vin8_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin8_SUT.c usage_Vin8_ClearInterrupt
    *******************************************************************************/
