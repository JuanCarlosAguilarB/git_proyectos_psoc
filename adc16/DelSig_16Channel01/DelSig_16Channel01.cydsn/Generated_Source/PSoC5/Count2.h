...
#if !(CY_PSOC5A &&\
	 Count2__PORT == 15 && ((Count2__MASK & 0xC0) != 0))
...
void    Count2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Count2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Count2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Count2_SetInterruptMode() function.
     *  @{
     */
        #define Count2_INTR_NONE      (uint16)(0x0000u)
        #define Count2_INTR_RISING    (uint16)(0x0001u)
        #define Count2_INTR_FALLING   (uint16)(0x0002u)
        #define Count2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Count2_INTR_MASK      (0x01u) 
#endif /* (Count2__INTSTAT) */
...
/* SIO registers */
#if defined(Count2__SIO_CFG)
    #define Count2_SIO_HYST_EN        (* (reg8 *) Count2__SIO_HYST_EN)
    #define Count2_SIO_REG_HIFREQ     (* (reg8 *) Count2__SIO_REG_HIFREQ)
    #define Count2_SIO_CFG            (* (reg8 *) Count2__SIO_CFG)
    #define Count2_SIO_DIFF           (* (reg8 *) Count2__SIO_DIFF)
#endif /* (Count2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Count2_0_INTTYPE_REG 		(* (reg8 *) Count2__0__INTTYPE)
#endif /* (Count2__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Count2_H */
