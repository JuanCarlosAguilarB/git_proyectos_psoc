...
*
* \funcusage
*  \snippet VinC_SUT.c usage_VinC_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinC_SUT.c usage_VinC_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet VinC_SUT.c usage_VinC_Read  
*******************************************************************************/
...
* preferred VinC_Read() API because the 
* VinC_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet VinC_SUT.c usage_VinC_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: VinC_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use VinC_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - VinC_0_INTR       (First pin in the list)
    *  - VinC_1_INTR       (Second pin in the list)
    *  - ...
    *  - VinC_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet VinC_SUT.c usage_VinC_SetInterruptMode
    *******************************************************************************/
    void VinC_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & VinC_0_INTR) != 0u) 
		{ 
			 VinC_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet VinC_SUT.c usage_VinC_ClearInterrupt
    *******************************************************************************/
