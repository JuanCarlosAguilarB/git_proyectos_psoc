...
#ifdef Delay_PWM_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* Delay_PWM_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void Delay_PWM_Init(void) 
{
        ...
        ctrl = Delay_PWM_CONTROL & ((uint8)(~Delay_PWM_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~Delay_PWM_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void Delay_PWM_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                Delay_PWM_CONTROL &= ((uint8)(~(Delay_PWM_CTRL_CMPMODE1_MASK |
                                            Delay_PWM_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    uint8 Delay_PWM_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(Delay_PWM_COUNTERCAP_LSB_PTR_8BIT);
...
void Delay_PWM_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(Delay_PWM_STATUS_PTR));
    }
