...
*
* \funcusage
*  \snippet Vin6_SUT.c usage_Vin6_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin6_SUT.c usage_Vin6_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin6_SUT.c usage_Vin6_Read  
*******************************************************************************/
...
* preferred Vin6_Read() API because the 
* Vin6_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin6_SUT.c usage_Vin6_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin6_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin6_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin6_0_INTR       (First pin in the list)
    *  - Vin6_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin6_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin6_SUT.c usage_Vin6_SetInterruptMode
    *******************************************************************************/
    void Vin6_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin6_0_INTR) != 0u) 
		{ 
			 Vin6_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin6_SUT.c usage_Vin6_ClearInterrupt
    *******************************************************************************/
