...
*
* \funcusage
*  \snippet Vin4_SUT.c usage_Vin4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin4_SUT.c usage_Vin4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin4_SUT.c usage_Vin4_Read  
*******************************************************************************/
...
* preferred Vin4_Read() API because the 
* Vin4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin4_SUT.c usage_Vin4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin4_0_INTR       (First pin in the list)
    *  - Vin4_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin4_SUT.c usage_Vin4_SetInterruptMode
    *******************************************************************************/
    void Vin4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin4_0_INTR) != 0u) 
		{ 
			 Vin4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin4_SUT.c usage_Vin4_ClearInterrupt
    *******************************************************************************/
