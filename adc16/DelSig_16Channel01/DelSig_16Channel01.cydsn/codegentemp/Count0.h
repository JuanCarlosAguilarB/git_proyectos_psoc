...
#if !(CY_PSOC5A &&\
	 Count0__PORT == 15 && ((Count0__MASK & 0xC0) != 0))
...
void    Count0_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Count0_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Count0__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Count0_SetInterruptMode() function.
     *  @{
     */
        #define Count0_INTR_NONE      (uint16)(0x0000u)
        #define Count0_INTR_RISING    (uint16)(0x0001u)
        #define Count0_INTR_FALLING   (uint16)(0x0002u)
        #define Count0_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Count0_INTR_MASK      (0x01u) 
#endif /* (Count0__INTSTAT) */
...
/* SIO registers */
#if defined(Count0__SIO_CFG)
    #define Count0_SIO_HYST_EN        (* (reg8 *) Count0__SIO_HYST_EN)
    #define Count0_SIO_REG_HIFREQ     (* (reg8 *) Count0__SIO_REG_HIFREQ)
    #define Count0_SIO_CFG            (* (reg8 *) Count0__SIO_CFG)
    #define Count0_SIO_DIFF           (* (reg8 *) Count0__SIO_DIFF)
#endif /* (Count0__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Count0_0_INTTYPE_REG 		(* (reg8 *) Count0__0__INTTYPE)
#endif /* (Count0__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Count0_H */
