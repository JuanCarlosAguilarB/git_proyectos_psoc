...
#if !(CY_PSOC5A &&\
	 Vin9__PORT == 15 && ((Vin9__MASK & 0xC0) != 0))
...
void    Vin9_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Vin9_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Vin9__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Vin9_SetInterruptMode() function.
     *  @{
     */
        #define Vin9_INTR_NONE      (uint16)(0x0000u)
        #define Vin9_INTR_RISING    (uint16)(0x0001u)
        #define Vin9_INTR_FALLING   (uint16)(0x0002u)
        #define Vin9_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Vin9_INTR_MASK      (0x01u) 
#endif /* (Vin9__INTSTAT) */
...
/* SIO registers */
#if defined(Vin9__SIO_CFG)
    #define Vin9_SIO_HYST_EN        (* (reg8 *) Vin9__SIO_HYST_EN)
    #define Vin9_SIO_REG_HIFREQ     (* (reg8 *) Vin9__SIO_REG_HIFREQ)
    #define Vin9_SIO_CFG            (* (reg8 *) Vin9__SIO_CFG)
    #define Vin9_SIO_DIFF           (* (reg8 *) Vin9__SIO_DIFF)
#endif /* (Vin9__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Vin9_0_INTTYPE_REG 		(* (reg8 *) Vin9__0__INTTYPE)
#endif /* (Vin9__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Vin9_H */
