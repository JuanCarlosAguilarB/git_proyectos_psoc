...
#if !(CY_PSOC5A &&\
	 VinE__PORT == 15 && ((VinE__MASK & 0xC0) != 0))
...
void    VinE_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the VinE_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(VinE__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in VinE_SetInterruptMode() function.
     *  @{
     */
        #define VinE_INTR_NONE      (uint16)(0x0000u)
        #define VinE_INTR_RISING    (uint16)(0x0001u)
        #define VinE_INTR_FALLING   (uint16)(0x0002u)
        #define VinE_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define VinE_INTR_MASK      (0x01u) 
#endif /* (VinE__INTSTAT) */
...
/* SIO registers */
#if defined(VinE__SIO_CFG)
    #define VinE_SIO_HYST_EN        (* (reg8 *) VinE__SIO_HYST_EN)
    #define VinE_SIO_REG_HIFREQ     (* (reg8 *) VinE__SIO_REG_HIFREQ)
    #define VinE_SIO_CFG            (* (reg8 *) VinE__SIO_CFG)
    #define VinE_SIO_DIFF           (* (reg8 *) VinE__SIO_DIFF)
#endif /* (VinE__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define VinE_0_INTTYPE_REG 		(* (reg8 *) VinE__0__INTTYPE)
#endif /* (VinE__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_VinE_H */
