...
#if !(CY_PSOC5A &&\
	 SOCpin__PORT == 15 && ((SOCpin__MASK & 0xC0) != 0))
...
void    SOCpin_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the SOCpin_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(SOCpin__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in SOCpin_SetInterruptMode() function.
     *  @{
     */
        #define SOCpin_INTR_NONE      (uint16)(0x0000u)
        #define SOCpin_INTR_RISING    (uint16)(0x0001u)
        #define SOCpin_INTR_FALLING   (uint16)(0x0002u)
        #define SOCpin_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define SOCpin_INTR_MASK      (0x01u) 
#endif /* (SOCpin__INTSTAT) */
...
/* SIO registers */
#if defined(SOCpin__SIO_CFG)
    #define SOCpin_SIO_HYST_EN        (* (reg8 *) SOCpin__SIO_HYST_EN)
    #define SOCpin_SIO_REG_HIFREQ     (* (reg8 *) SOCpin__SIO_REG_HIFREQ)
    #define SOCpin_SIO_CFG            (* (reg8 *) SOCpin__SIO_CFG)
    #define SOCpin_SIO_DIFF           (* (reg8 *) SOCpin__SIO_DIFF)
#endif /* (SOCpin__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define SOCpin_0_INTTYPE_REG 		(* (reg8 *) SOCpin__0__INTTYPE)
#endif /* (SOCpin__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_SOCpin_H */
