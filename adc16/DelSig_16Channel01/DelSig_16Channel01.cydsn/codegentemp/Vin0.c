...
*
* \funcusage
*  \snippet Vin0_SUT.c usage_Vin0_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin0_SUT.c usage_Vin0_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Vin0_SUT.c usage_Vin0_Read  
*******************************************************************************/
...
* preferred Vin0_Read() API because the 
* Vin0_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Vin0_SUT.c usage_Vin0_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Vin0_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Vin0_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Vin0_0_INTR       (First pin in the list)
    *  - Vin0_1_INTR       (Second pin in the list)
    *  - ...
    *  - Vin0_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Vin0_SUT.c usage_Vin0_SetInterruptMode
    *******************************************************************************/
    void Vin0_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Vin0_0_INTR) != 0u) 
		{ 
			 Vin0_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Vin0_SUT.c usage_Vin0_ClearInterrupt
    *******************************************************************************/
